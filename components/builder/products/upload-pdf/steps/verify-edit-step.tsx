...
export function VerifyEditStep({ onNotice }: { onNotice: (notice: string) => void }) {
  return (
    <PdfPanel index="05" title="Verify & edit" action={<button onClick={() => onNotice("Verified products published.")} type="button">Publish</button>}>
