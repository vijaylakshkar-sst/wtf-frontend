        ...
        <div className="product-pdf-shell">
          <header className="product-pdf-header">
            <div className="product-pdf-breadcrumb">
              <Link href="/supplier/product-management">Product management</Link>
              <ArrowIcon size={14} />
          ...
          <div className="product-pdf-info"><span>i</span><p><strong>All extracted supplier products go straight to verification before publishing.</strong><br />You can manage, map and associate products with builders later from Product Management.</p></div>
